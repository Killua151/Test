...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  FTSetGoalCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([FTSetGoalCell class])];
  
  if (cell == nil)
    cell = [FTSetGoalCell new];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
  return [FTSetGoalCell heightToFitWithData:_goalsData[indexPath.row]];
}
