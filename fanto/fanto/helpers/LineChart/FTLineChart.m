...
@synthesize yMaxValue = _yMaxValue;
@synthesize yMinValue = _yMinValue;
@synthesize labelFont = _labelFont;
@synthesize labelTextColor = _labelTextColor;
@synthesize chartMargin = _chartMargin;
...
- (void)_strokeLineAndPointsWithData:(FTLineChartData *)chartData
{
  ...
  if (chartData.pointColor != nil) {
    pointLayer.strokeColor = chartData.pointColor.CGColor;
    pointLayer.fillColor = chartData.pointColor.CGColor;
  } else
  ...
  if (chartData.pointStyle != SPLineChartPointStyleCycle) {
    ...
    if (chartData.pointColor != nil) {
      ...
      fillColorAnimation.duration = self.drawingDuration;
      fillColorAnimation.fromValue = (id)[[UIColor clearColor] CGColor];
      fillColorAnimation.toValue = (id)[chartData.pointColor CGColor];
      fillColorAnimation.removedOnCompletion = YES;
      [pointLayer addAnimation:fillColorAnimation forKey:@"fillColor"];
    }
  }
