...
@interface UIView (ExtendedToastPrivate)
...
@implementation UIView (ExtendedToast)

#pragma mark - Toast Methods

- (UIView *)toastWithMessage:(NSString *)message {
  return [self viewForMessage:message title:nil image:nil];
}
