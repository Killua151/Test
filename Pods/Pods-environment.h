...
// SPChart
#define COCOAPODS_POD_AVAILABLE_SPChart
#define COCOAPODS_VERSION_MAJOR_SPChart 0
#define COCOAPODS_VERSION_MINOR_SPChart 1
#define COCOAPODS_VERSION_PATCH_SPChart 3
