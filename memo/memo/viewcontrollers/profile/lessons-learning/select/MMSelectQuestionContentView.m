...
@interface MMSelectQuestionContentView () {
...
@implementation MMSelectQuestionContentView
...
- (void)setupViews {
  ...
  for (NSInteger i = 0; i < 2; i++)
    for (NSInteger j = 0; j < 2; j++) {
      ...
      MMSelectQuestionButton *button = [[MMSelectQuestionButton alloc] initWithOption:_optionsData[index] atIndex:index];
